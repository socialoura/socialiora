...
const reviews: Review[] = [
  {
    ...
    text: {
      ...
      es: '¡Servicio increíble! Al principio era escéptica, pero los resultados superaron mis expectativas. Mi engagement ha aumentado significativamente y los seguidores parecen totalmente orgánicos. ¡Lo recomiendo!',
    },
    date: '2 days ago',
    verified: true,
  },
  {
    ...
    followers: '+5,000',
    text: {
      en: 'As a fitness influencer, I needed real growth. Socialiora delivered exactly that. The delivery was gradual and natural-looking. My brand partnerships have increased since using their service.',
      fr: 'En tant qu\'influenceur fitness, j\'avais besoin d\'une vraie croissance. Socialiora a livré exactement cela. La livraison était progressive et naturelle. Mes partenariats de marque ont augmenté depuis.',
      de: 'Als Fitness-Influencer brauchte ich echtes Wachstum. Socialiora hat genau das geliefert. Die Lieferung war schrittweise und natürlich. Meine Markenpartnerschaften sind seitdem gestiegen.',
      es: 'Como influencer de fitness, necesitaba crecimiento real. Socialiora entregó exactamente eso. La entrega fue gradual y natural. Mis colaboraciones con marcas han aumentado desde entonces.',
    },
    date: '1 week ago',
    verified: true,
  },
  {
    ...
    text: {
      ...
      es: '¡Empecé con 500 seguidores en TikTok y ahora tengo 15K! El crecimiento fue constante y mis vídeos empezaron a tener muchas más visualizaciones. ¡La mejor inversión para mi carrera como creadora!',
    },
    date: '3 days ago',
    verified: true,
  },
  {
    ...
    text: {
      ...
      es: 'Mi cuenta de fotografía profesional necesitaba un impulso. Recibí exactamente lo que pagué, entregado a tiempo. El equipo de soporte fue muy útil. ¡Volveré a pedir!',
    },
    date: '5 days ago',
    verified: true,
  },
  {
    ...
    text: {
      ...
      es: '¡Mi contenido de viajes por fin recibe la atención que merece! Los seguidores son reales e interactúan con mis publicaciones. El servicio al cliente respondió en horas. ¡Experiencia increíble!',
    },
    date: '1 week ago',
    verified: true,
  },
  {
    ...
    followers: '+7,500',
    text: {
      en: 'As a musician, visibility is everything. Socialiora helped me reach new audiences. My music clips are now getting shared more than ever. The growth feels completely natural!',
      fr: 'En tant que musicien, la visibilité est primordiale. Socialiora m\'a aidé à atteindre de nouveaux publics. Mes clips sont maintenant partagés plus que jamais. La croissance semble totalement naturelle !',
      de: 'Als Musiker ist Sichtbarkeit alles. Socialiora hat mir geholfen, neues Publikum zu erreichen. Meine Musikclips werden jetzt mehr geteilt als je zuvor. Das Wachstum fühlt sich völlig natürlich an!',
      es: 'Como músico, la visibilidad lo es todo. Socialiora me ayudó a llegar a nuevas audiencias. Mis clips musicales se comparten más que nunca. ¡El crecimiento se siente completamente natural!',
    },
    date: '4 days ago',
    verified: true,
  },
  {
    ...
    text: {
      ...
      es: '¡Las marcas de belleza empezaron a fijarse en mí después de que crecieron mis seguidores! El proceso fue fluido y seguro. Sin contraseña, solo mi nombre de usuario. Súper seguro y efectivo.',
    },
    date: '6 days ago',
    verified: true,
  },
  {
    ...
    followers: '+2,000',
    text: {
      en: 'Food blogger here! My recipes are reaching so many more people now. The engagement on my posts has doubled. Worth every penny. Thank you Socialiora!',
      fr: 'Blogueur culinaire ici ! Mes recettes atteignent tellement plus de personnes maintenant. L\'engagement sur mes posts a doublé. Chaque centime en valait la peine. Merci Socialiora !',
      de: 'Food-Blogger hier! Meine Rezepte erreichen jetzt so viel mehr Menschen. Das Engagement auf meinen Beiträgen hat sich verdoppelt. Jeden Cent wert. Danke Socialiora!',
      es: '¡Soy bloguero de cocina! Mis recetas llegan a muchas más personas ahora. El engagement en mis publicaciones se ha duplicado. Vale cada céntimo. ¡Gracias Socialiora!',
    },
    date: '1 week ago',
    verified: true,
  },
  {
    ...
    text: {
      ...
      es: 'Mis publicaciones por fin empezaron a tener un alcance constante. El crecimiento se sintió natural y mi tasa de engagement mejoró mucho.',
    },
    date: '3 days ago',
    verified: true,
  },
  {
    ...
    text: {
      ...
      es: 'Perfecto para construir credibilidad rápidamente. Vi mejor interacción en mis hilos en la primera semana.',
    },
    date: '5 days ago',
    verified: true,
  },
  {
    ...
    text: {
      ...
      es: 'Gran soporte y proceso claro. La calidad de mi audiencia mejoró y recibí más visitas al perfil.',
    },
    date: '2 weeks ago',
    verified: true,
  },
...
export default function ReviewsSection({ lang, platform = 'all' }: ReviewsSectionProps) {
  ...
  const content = {
    en: {
      ...
      subtitle: 'Join thousands of satisfied customers who have grown their social media presence with Socialiora',
      verified: 'Verified Purchase',
      followers: 'followers gained',
    },
    fr: {
      title: 'Adoré par les Créateurs du Monde Entier',
      subtitle: 'Rejoignez des milliers de clients satisfaits qui ont développé leur présence sur les réseaux sociaux avec Socialiora',
      verified: 'Achat Vérifié',
      followers: 'abonnés gagnés',
    },
    de: {
      title: 'Beliebt bei Creators weltweit',
      subtitle: 'Schließen Sie sich Tausenden zufriedener Kunden an, die ihre Social-Media-Präsenz mit Socialiora ausgebaut haben',
      verified: 'Verifizierter Kauf',
      followers: 'Follower gewonnen',
    },
    es: {
      title: 'Amado por Creadores de Todo el Mundo',
      subtitle: 'Únete a miles de clientes satisfechos que han hecho crecer su presencia en redes sociales con Socialiora',
      verified: 'Compra Verificada',
      followers: 'seguidores ganados',
    },
  };
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex items-center justify-center gap-8 mt-8">
            <div className="text-center">
              ...
              <div className="text-sm text-gray-500">{lang === 'fr' ? 'Clients Satisfaits' : lang === 'de' ? 'Zufriedene Kunden' : lang === 'es' ? 'Clientes Satisfechos' : 'Happy Customers'}</div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-gray-500">{lang === 'fr' ? 'Note Moyenne' : lang === 'de' ? 'Durchschnittsbewertung' : lang === 'es' ? 'Valoración Media' : 'Average Rating'}</div>
            </div>
            <div className="w-px h-12 bg-gray-700" />
            <div className="text-center">
              <div className="text-3xl font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
              ...
              <div className="text-sm text-gray-500">{lang === 'fr' ? 'Abonnés Livrés' : lang === 'de' ? 'Follower geliefert' : lang === 'es' ? 'Seguidores Entregados' : 'Followers Delivered'}</div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 flex flex-wrap items-center justify-center gap-6 text-gray-500">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm">{lang === 'fr' ? 'Avis Vérifiés' : lang === 'de' ? 'Verifizierte Bewertungen' : lang === 'es' ? 'Reseñas Verificadas' : 'Verified Reviews'}</span>
          </div>
          <div className="flex items-center gap-2">
            <svg className="w-5 h-5 text-blue-500" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" />
            </svg>
            <span className="text-sm">{lang === 'fr' ? 'Paiements Sécurisés' : lang === 'de' ? 'Sichere Zahlungen' : lang === 'es' ? 'Pagos Seguros' : 'Secure Payments'}</span>
          </div>
          <div className="flex items-center gap-2">
            <svg className="w-5 h-5 text-purple-500" fill="currentColor" viewBox="0 0 20 20">
              <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
            </svg>
            <span className="text-sm">{lang === 'fr' ? 'Service 5 Étoiles' : lang === 'de' ? '5-Sterne-Service' : lang === 'es' ? 'Servicio 5 Estrellas' : '5-Star Service'}</span>
          </div>
        </div>
      </div>
    </section>
