          ...
          return (
            ...
            >
              ...
              {service.type === 'followers' && (
                <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 sm:top-3 sm:left-auto sm:right-3 sm:translate-x-0 sm:translate-y-0 z-20 border border-pink-500/50 text-pink-400 bg-gray-900 text-[10px] sm:text-xs font-bold uppercase tracking-wider px-2 py-0.5 rounded-full flex items-center gap-1">
