  ...
  return (
    <div className="w-full max-w-5xl mx-auto flex flex-col h-full pb-28 sm:pb-32">
      ...
      <div className="flex items-center justify-between mb-6 pb-4 border-b border-gray-800/50">
        ...
        {hasSelectedPosts && (
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-pink-500/10 border border-pink-500/20 text-pink-400 text-sm font-semibold">
          ...
          return (
            <button
              ...
              className={`group relative aspect-[4/5] rounded-xl sm:rounded-2xl overflow-hidden transition-colors duration-200 ${
                isSelected
                  ? 'ring-2 ring-pink-500 ring-offset-2 sm:ring-offset-4 ring-offset-gray-950'
            ...
            >
              ...
              {isSelected && (
                <div className="absolute inset-0 flex flex-col items-center justify-center gap-3">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-gradient-to-tr from-yellow-500 via-pink-500 to-purple-600 flex items-center justify-center shadow-lg">
              ...
              {isSelected && dist && (
                <div className="absolute bottom-2 sm:bottom-3 left-2 sm:left-3 right-2 sm:right-3">
                  <div className="bg-gray-900/90 rounded-lg sm:rounded-xl py-1.5 sm:py-2 px-2 sm:px-3 text-center border border-gray-700/50">
                    <span className="text-pink-400 text-[10px] sm:text-sm font-black tracking-tight">
