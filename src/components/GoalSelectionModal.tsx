...
export default function GoalSelectionModal({
  ...
  const text = {
    en: {
      ...
      continue: 'Continue',
      disclaimer: `**Socialiora is fully aligned with the terms of service of ${platform === 'instagram' ? 'Instagram' : platform === 'tiktok' ? 'TikTok' : platform === 'youtube' ? 'YouTube' : platform === 'linkedin' ? 'LinkedIn' : 'X (Twitter)'} and Google Ads. Our approach is based on authentic marketing strategies and professional partnerships.**`,
      ...
      disclaimerPart3: '**Disclaimer:** Visibility results depend on your content quality, niche relevance, and consistency. While Socialiora provides exposure tools, we do not promise specific performance metrics.',
    ...
    fr: {
      ...
      continue: 'Continuer',
      disclaimer: `**Socialiora est entièrement conforme aux conditions d'utilisation de ${platform === 'instagram' ? 'Instagram' : platform === 'tiktok' ? 'TikTok' : platform === 'youtube' ? 'YouTube' : platform === 'linkedin' ? 'LinkedIn' : 'X (Twitter)'} et Google Ads. Notre approche est basée sur des stratégies marketing authentiques et des partenariats professionnels.**`,
      ...
      disclaimerPart3: '**Avertissement :** Les résultats de visibilité dépendent de la qualité de votre contenu, de la pertinence de votre niche et de votre régularité. Bien que Socialiora fournisse des outils d\'exposition, nous ne promettons pas de mesures de performance spécifiques.',
    ...
    de: {
      ...
      disclaimerPart3: '**Haftungsausschluss:** Die Sichtbarkeitsergebnisse hängen von der Qualität Ihres Contents, der Nischenrelevanz und Ihrer Konsistenz ab. Obwohl Socialiora Reichweiten-Tools bereitstellt, versprechen wir keine bestimmten Leistungskennzahlen.',
    ...
    es: {
      ...
      continue: 'Continuar',
      disclaimer: `**Socialiora cumple plenamente con los términos de servicio de ${platform === 'instagram' ? 'Instagram' : platform === 'tiktok' ? 'TikTok' : platform === 'youtube' ? 'YouTube' : platform === 'linkedin' ? 'LinkedIn' : 'X (Twitter)'} y Google Ads. Nuestro enfoque se basa en estrategias de marketing auténticas y asociaciones profesionales.**`,
      ...
      disclaimerPart3: '**Aviso:** Los resultados de visibilidad dependen de la calidad de tu contenido, la relevancia de tu nicho y tu consistencia. Aunque Socialiora proporciona herramientas de exposición, no prometemos métricas de rendimiento específicas.',
