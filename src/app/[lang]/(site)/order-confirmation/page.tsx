...
export default function OrderConfirmationPage({
  ...
  const text = {
    en: {
      ...
      thankYouMessage: 'We appreciate your trust in Socialiora. Your success is our priority!',
    ...
    de: {
      ...
      thankYouMessage: 'Wir schätzen Ihr Vertrauen in Socialiora. Ihr Erfolg ist unsere Priorität!',
    ...
    es: {
      ...
      step1Title: 'Procesando el pedido',
      step1Desc: 'Tu pedido está siendo procesado por nuestro equipo',
      step2Title: 'Entrega Gradual',
      step2Desc: 'Empezarás a ver resultados en 24-48 horas',
      step3Title: 'Crecimiento Natural',
      step3Desc: 'Los seguidores se añadirán gradualmente para un engagement auténtico',
      backHome: 'Volver al Inicio',
      viewPricing: 'Ver Otros Planes',
      support: '¿Necesitas ayuda?',
      contactSupport: 'Contactar Soporte',
      thankYouMessage: 'Agradecemos tu confianza en Socialiora. ¡Tu éxito es nuestra prioridad!',
    ...
    fr: {
      ...
      thankYouMessage: 'Nous apprécions votre confiance en Socialiora. Votre succès est notre priorité !',
  ...
  useEffect(() => {
    ...
    if (orderId && platform && followers && price) {
      setOrderDetails({
        ...
        email: email || '',
        username: username || '',
        date: new Date().toLocaleDateString(lang === 'fr' ? 'fr-FR' : lang === 'de' ? 'de-DE' : lang === 'es' ? 'es-ES' : 'en-US', {
          year: 'numeric',
          month: 'long',
          day: 'numeric',
        }),
