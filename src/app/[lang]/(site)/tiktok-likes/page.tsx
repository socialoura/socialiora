...
export default function TikTokLikesPage({ params }: PageProps) {
  ...
  const handleContinue = () => {
    ...
    if (!TIKTOK_URL_REGEX.test(trimmed)) {
      const errorText = lang === 'fr'
        ? 'Veuillez entrer une URL TikTok valide (ex: https://vm.tiktok.com/...)'
        : lang === 'de'
        ? 'Bitte geben Sie eine gültige TikTok-URL ein (z.B. https://vm.tiktok.com/...)'
        : lang === 'es'
        ? 'Introduce una URL de TikTok válida (ej: https://vm.tiktok.com/...)'
        : 'Please enter a valid TikTok URL (e.g. https://vm.tiktok.com/...)';
        ...
        <div className="relative mx-auto max-w-5xl px-6 py-8 sm:py-20 lg:px-8 w-full">
          <div className="text-center">
            ...
            <div className="max-w-xl mx-auto">
              ...
              {urlError && (
                <p className="text-red-400 text-sm mt-2 text-left px-2">{urlError}</p>
              )}
