  ...
  const content = {
    ...
    es: {
      hero: {
        title: 'IMPULSA TU',
        highlight: 'ENGAGEMENT',
        subtitle: 'Lanza una campaña de engagement para tu publicación de Instagram para mejorar la visibilidad, reforzar la prueba social y apoyar tu promoción.',
        badges: [
          { text: 'Campaña de engagement' },
          { text: 'Entrega instantánea' },
          { text: 'Sin contraseña' },
        ],
        cta: 'EMPEZAR',
        placeholder: 'Pega la URL de tu publicación de Instagram',
      },
      why: {
        title: '¿Por qué lanzar una campaña de engagement en Instagram?',
        cards: [
          {
            title: 'Aumentar el engagement',
            description: 'Señales de engagement más fuertes ayudan a Instagram a distribuir mejor tu contenido en Explorar y Reels.',
            icon: 'TrendingUp',
          },
          {
            title: 'Prueba social',
        ...
        steps: [
          {
            ...
            description: 'Copia la URL de la publicación de Instagram que quieres promocionar y pégala arriba. Sin login ni contraseña.',
          },
          {
            title: 'ELIGE TU PAQUETE',
            description: 'Elige el tamaño de campaña que se ajuste a tus objetivos. Paquetes flexibles de 50 a 10.000+.',
          },
          {
            title: 'RASTREA TU ENGAGEMENT',
            description: 'La campaña comienza poco después del pago y apoya tu publicación durante tu período de promoción.',
          },
        ],
        cta: 'EMPEZAR AHORA',
      },
      benefits: {
        ...
        items: [
          ...
          { title: 'Sin contraseña', desc: 'Solo necesitamos la URL de tu publicación. Tu cuenta sigue segura.' },
