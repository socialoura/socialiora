...
const marketingContent = {
  en: {
    difference: {
      title: 'Why boost your TikTok growth with AI',
      cards: [
        { title: 'Precise AI targeting', description: 'Our artificial intelligence analyzes your niche and content to connect you with real TikTok users interested in your topics. No bots, only authentic accounts.', icon: 'Bot' as const },
        { title: 'Natural progressive delivery', description: 'Your audience grows gradually to mimic organic development. Our AI system adjusts the pace to guarantee the total security of your account.', icon: 'Clock' as const },
        { title: '100% Secure and compliant', description: 'No password required. Our growth strategy method is fully compliant with TikTok rules. Your account stays 100% protected.', icon: 'Shield' as const },
      ],
    },
    howItWorks: {
      title: 'Start your TikTok growth in 3 steps',
      cards: [
        ...
        { number: '2', title: 'CHOOSE YOUR GROWTH PLAN', description: 'Select the audience development solution you need. From 100 to 100K+ real engagement, AI-targeted based on your content.', icon: 'Megaphone' as const },
        { number: '3', title: 'ACCELERATE YOUR GROWTH', description: 'Your audience starts growing within minutes. Our AI delivers progressive results for natural and secure development.', icon: 'BarChart3' as const },
      ],
      cta: 'START NOW',
    },
    benefits: {
      title: 'Why boost your TikTok presence',
      items: [
        'More engagement = more visibility on the For You Page',
        'Social proof attracts even more organic followers',
        'Brands collaborate with high-audience accounts',
        'Optimize the TikTok algorithm with enhanced reach',
        '100% secure strategy, guaranteed results, real engagement',
      ],
    },
    compliance: {
      text: 'Transparency: Socialiora helps you grow your TikTok presence through AI technology that connects with authentic users interested in your content. We never use bots or fake accounts. Our growth method is designed to comply with TikTok guidelines and guarantee the security of your account. All engagement comes from real active users.',
    },
  },
  fr: {
    difference: {
      title: 'Pourquoi booster votre croissance TikTok avec l\'IA',
      cards: [
        { title: 'Ciblage IA précis', description: 'Notre intelligence artificielle analyse votre niche et votre contenu pour vous connecter avec de vrais utilisateurs TikTok intéressés par votre thématique. Pas de bots, que des comptes authentiques.', icon: 'Bot' as const },
        { title: 'Développement progressif naturel', description: 'Votre audience grandit progressivement pour imiter une croissance organique. Notre système IA ajuste le rythme pour garantir la sécurité totale de votre compte.', icon: 'Clock' as const },
        { title: '100% Sécurisé et conforme', description: 'Aucun mot de passe requis. Notre stratégie de croissance est entièrement conforme aux règles TikTok. Votre compte reste protégé à 100%.', icon: 'Shield' as const },
      ],
    },
    howItWorks: {
      title: 'Démarrez votre croissance TikTok en 3 étapes',
      cards: [
        ...
        { number: '2', title: 'CHOISISSEZ VOTRE PLAN DE CROISSANCE', description: 'Sélectionnez la solution de développement d\'audience dont vous avez besoin. De 100 à 100K+ d\'engagement réel, ciblé par IA selon votre contenu.', icon: 'Megaphone' as const },
        { number: '3', title: 'ACCÉLÉREZ VOTRE CROISSANCE', description: 'Votre audience commence à grandir en quelques minutes. Notre IA livre des résultats progressifs pour un développement naturel et sécurisé.', icon: 'BarChart3' as const },
      ],
      cta: 'DÉMARRER MAINTENANT',
    },
    benefits: {
      title: 'Pourquoi booster votre présence TikTok',
      items: [
        'Plus d\'engagement = plus de visibilité sur la page Pour Toi',
        'La preuve sociale attire encore plus d\'abonnés organiques',
        'Les marques collaborent avec les comptes à forte audience',
        'Optimisez l\'algorithme TikTok avec une meilleure portée',
        'Stratégie 100% sécurisée, résultats garantis, engagement réel',
      ],
    },
    compliance: {
      text: 'Transparence : Socialiora vous aide à développer votre présence TikTok grâce à une technologie IA qui connecte avec des utilisateurs authentiques intéressés par votre contenu. Nous n\'utilisons jamais de bots ou de faux comptes. Notre méthode de croissance est conçue pour respecter les directives TikTok et garantir la sécurité de votre compte. Tout l\'engagement provient de vrais utilisateurs actifs.',
    },
  },
  de: {
    difference: {
      title: 'Warum Ihr TikTok-Wachstum mit KI steigern',
      cards: [
        { title: 'Präzises KI-Targeting', description: 'Unsere künstliche Intelligenz analysiert Ihre Nische und Ihren Content, um Sie mit echten TikTok-Nutzern zu verbinden, die an Ihren Themen interessiert sind. Keine Bots, nur authentische Konten.', icon: 'Bot' as const },
        { title: 'Natürliche progressive Entwicklung', description: 'Ihre Zielgruppe wächst schrittweise, um organisches Wachstum zu imitieren. Unser KI-System passt das Tempo an, um die totale Sicherheit Ihres Kontos zu garantieren.', icon: 'Clock' as const },
        { title: '100% Sicher und konform', description: 'Kein Passwort erforderlich. Unsere Wachstumsstrategie ist vollständig konform mit den TikTok-Regeln. Ihr Konto bleibt zu 100% geschützt.', icon: 'Shield' as const },
      ],
    },
    howItWorks: {
      title: 'Starten Sie Ihr TikTok-Wachstum in 3 Schritten',
      cards: [
        ...
        { number: '2', title: 'WÄHLEN SIE IHR WACHSTUMS-PLAN', description: 'Wählen Sie die Zielgruppen-Entwicklungslösung, die Sie benötigen. Von 100 bis 100K+ echtes Engagement, KI-gesteuert nach Ihrem Content.', icon: 'Megaphone' as const },
        { number: '3', title: 'BESCHLEUNIGEN SIE IHR WACHSTUM', description: 'Ihre Zielgruppe beginnt innerhalb von Minuten zu wachsen. Unsere KI liefert progressive Ergebnisse für natürliches und sicheres Wachstum.', icon: 'BarChart3' as const },
      ],
      cta: 'JETZT STARTEN',
    },
    benefits: {
      title: 'Warum Ihre TikTok-Präsenz steigern',
      items: [
        'Mehr Engagement = mehr Sichtbarkeit auf der For-You-Seite',
        'Social Proof zieht noch mehr organische Follower an',
        'Marken arbeiten mit Accounts mit hoher Reichweite zusammen',
        'Optimieren Sie den TikTok-Algorithmus mit besserer Reichweite',
        '100% sichere Strategie, garantierte Ergebnisse, echtes Engagement',
      ],
    },
    compliance: {
      text: 'Transparenz: Socialiora hilft Ihnen, Ihre TikTok-Präsenz durch KI-Technologie zu steigern, die authentische Nutzer anspricht, die an Ihren Inhalten interessiert sind. Wir verwenden niemals Bots oder Fake-Accounts. Unsere Wachstumsmethode ist darauf ausgelegt, die TikTok-Richtlinien zu respektieren und die Sicherheit Ihres Kontos zu garantieren. Alles Engagement kommt von echten aktiven Nutzern.',
    },
  },
  es: {
    difference: {
      title: 'Por qué potenciar tu crecimiento TikTok con IA',
      cards: [
        { title: 'Segmentación IA precisa', description: 'Nuestra inteligencia artificial analiza tu nicho y contenido para conectarte con usuarios reales de TikTok interesados en tu temática. Sin bots, solo cuentas auténticas.', icon: 'Bot' as const },
        { title: 'Desarrollo progresivo natural', description: 'Tu audiencia crece progresivamente para imitar un crecimiento orgánico. Nuestro sistema IA ajusta el ritmo para garantizar la seguridad total de tu cuenta.', icon: 'Clock' as const },
        { title: '100% Seguro y conforme', description: 'No se requiere contraseña. Nuestra estrategia de crecimiento es totalmente conforme con las reglas de TikTok. Tu cuenta permanece protegida al 100%.', icon: 'Shield' as const },
      ],
    },
    howItWorks: {
      title: 'Inicia tu crecimiento TikTok en 3 pasos',
      cards: [
        ...
        { number: '2', title: 'ELIGE TU PLAN DE CRECIMIENTO', description: 'Selecciona la solución de desarrollo de audiencia que necesitas. De 100 a 100K+ de engagement real, dirigido por IA según tu contenido.', icon: 'Megaphone' as const },
        { number: '3', title: 'ACELERA TU CRECIMIENTO', description: 'Tu audiencia comienza a crecer en minutos. Nuestra IA entrega resultados progresivos para un desarrollo natural y seguro.', icon: 'BarChart3' as const },
      ],
      cta: 'INICIAR AHORA',
    },
    benefits: {
      title: 'Por qué potenciar tu presencia TikTok',
      items: [
        'Más engagement = más visibilidad en la página Para Ti',
        'La prueba social atrae aún más seguidores orgánicos',
        'Las marcas colaboran con cuentas de gran audiencia',
        'Optimiza el algoritmo TikTok con mejor alcance',
        'Estrategia 100% segura, resultados garantizados, engagement real',
      ],
    },
    compliance: {
      text: 'Transparencia: Socialiora te ayuda a desarrollar tu presencia TikTok a través de tecnología IA que conecta con usuarios auténticos interesados en tu contenido. Nunca usamos bots o cuentas falsas. Nuestro método de crecimiento está diseñado para respetar las directrices de TikTok y garantizar la seguridad de tu cuenta. Todo el engagement proviene de usuarios reales y activos.',
    },
  },
};
